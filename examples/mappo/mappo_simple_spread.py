...
if __name__ == "__main__":
    parser = parse_args()
    configs_dict = load_yaml(file_dir=f"mappo_mpe_configs/{parser.env_id}.yaml")
    ...
    if configs.benchmark:
        ...
        test_scores = Agents.test(
            test_episodes=test_episode, test_envs=test_envs, close_envs=False
        )
        ...
        if configs.test:
            ...
            scores = Agents.test(
                test_episodes=configs.test_episode, test_envs=test_envs, close_envs=True
            )
